...
![](/inc.github.io/assets/images/content/docs/dj-area/dj-admin_en.png)
...
However, since the system is always running even when no video is playing, a switch is provided to force the lights to turn on globally (synchronized for all players).
